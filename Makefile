...
TEST_SRCS = test_main.c test_stack.c test_tagged.c test_object.c test_dispatch.c test_blocks.c test_factorial.c test_transaction.c test_gc.c test_persist.c
